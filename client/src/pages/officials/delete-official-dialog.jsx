                ...
                switch (_a.label) {
                    case 0:
                        if (!(official === null || official === void 0 ? void 0 : official.id))
                            return [2 /*return*/];
                        return [4 /*yield*/, apiRequest('PATCH', "/api/officials/".concat(official.id, "/toggle-status"), {
        ...
        <div className="py-4">
          ...
          {official && official.departments && official.departments.length > 0 && (<div className="mb-4">
              ...
              <div className="flex flex-wrap gap-1">
                {official.departments.map(function (dept) {
                var departmentValue = typeof dept === 'string' ? dept : dept === null || dept === void 0 ? void 0 : dept.department;
                var key = typeof dept === 'string' ? dept : (dept === null || dept === void 0 ? void 0 : dept.id) || departmentValue;
                return (<Badge key={key} variant="outline" className="capitalize">
